...
const RULES: Rule[] = [
  ...
  // ── Sports (before outdoors so "Yankees" doesn't get caught by outdoors) ──
  {
    ...
    keywords: [
      ...
      'match day', 'game day', 'playoffs', 'doubleheader', 'opening day',
      'home game', 'away game',
      'basketball game', 'football game', 'soccer match', 'baseball game',
      'hockey game', 'tennis match', 'boxing match', 'ufc', 'mma fight',
      'world series', 'super bowl',
    ],
    antiKeywords: [
      'esports', 'e-sports', 'gaming', 'video game',
      'kith', 'fashion', 'collab', 'collection', 'merch', 'pop-up shop',
      'sample sale', 'brand', 'launch', 'capsule',
      'film', 'festival', 'screening', 'documentary', 'exhibition',
      'gallery', 'museum', 'mead',
    ],
    venuePatterns: [
      'madison square garden', 'msg', 'barclays center',
      ...
      'chase center', 'sofi stadium', 'crypto.com arena',
      'ubs arena', 'belmont park', 'aqueduct',
      'icahn stadium', 'national tennis center',
      'billie jean king', 'forest hills stadium',
    ],
  },
  // ── Outdoors ──
  {
